...
//  ชื่อนักศึกษา : กิติญาดา กองคำ
//  รหัสนักศึกษา : 673380509-6
// ╚══════════════════════════════════════════════════════════╝
//
//  โจทย์:
...
class Shipment {
    ...
    public String toString() {
        return String.format("%s  %5.2f กก. | %-8s |   %6.2f บาท", 
...
class ShippingCompany {
    ...
    //             2) บรรทัดแสดงยอดรวม
    //             เติมทั้งสองส่วนนั้น
// 👉 TODO G : ปรับแต่ง String ข้อความและเส้นคั่น
    public void printSummary() {
        ...
        // 2) แสดงยอดรวม (ปรับช่องว่างและคำให้ตรงตามรูป)
